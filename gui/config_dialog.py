...
class ConfigDialog(wx.Dialog):
    def __init__(self, parent, title, defaults):
        super(ConfigDialog, self).__init__(parent, title=title, size=(550, 520))
        ...
        labels = [
            ...
            "Bot Nickname:", "Initial Channel Path:", "Initial Status Msg:", "Admin Usernames (comma-sep):",
            "Gemini API Key:", "Weather API Key (OpenWeatherMap):", "News API Key (NewsAPI.org):",
            "Reconnect Delay (min/max sec):",
        ...
        for i, label_text in enumerate(labels):
            ...
            elif "Enable Debug Logging" in label_text:
            ...
            elif "Context History Retention" not in label_text and "Enable Debug Logging" not in label_text: # Ensure we don't re-add the context history control
                key_map = {
                    "server host:": "host", "server port:": "port", "bot username:": "username", "bot password:": "password",
                    "bot nickname:": "nickname", "initial channel path:": "initial_channel_path", 
                    "initial status msg:": "status_message", "admin usernames (comma-sep):": "admin_usernames", 
                    "gemini api key:": "gemini_api_key", "weather api key (openweathermap):": "weather_api_key", 
                    "news api key (newsapi.org):": "news_api_key"
                }
    ...
    def GetConfigData(self):
        ...
        structured_data = {
             ...
             'Database': {k: self.config_data.get(k, v) for k, v in DEFAULT_CONFIG['Database'].items()}
        }
